...
def normalise_input(user_input):
    ...
    #pass
    output = ""
    output = remove_punct(remove_spaces(user_input))
    output = output.lower()
...
def print_menu_line(direction, leads_to):
    ...
    """
    #pass
    #output_direction = direction.upper()
    print("Go " + str(direction.upper()) + " to " + leads_to + ".")
...
def print_menu(exits):
    ...
    for entry in exits:
        #print(entry)
        print_menu_line(entry, exit_leads_to(exits, entry))
